...
package CPAN::Metabase::User::EmailAddress;
use 5.006;
use strict;
use warnings;
our $VERSION = '0.001';
...
CPAN::Metabase::User::EmailAddress - Metabase fact for user email address

=head1 SYNOPSIS

  my $email = CPAN::Metabase::User::EmailAddress->new(
